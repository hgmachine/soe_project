...
class VisitorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post visitors_url, params: { visitor: { code: @visitor.code, hits: @visitor.hits, nickname: @visitor.nickname } }
    end
  ...
  test "should update visitor" do
    patch visitor_url(@visitor), params: { visitor: { code: @visitor.code, hits: @visitor.hits, nickname: @visitor.nickname } }
